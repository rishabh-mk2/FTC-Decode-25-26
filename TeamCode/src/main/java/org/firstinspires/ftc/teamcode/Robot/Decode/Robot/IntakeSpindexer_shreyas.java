...
//endregion
    ...
    private static final long DETECTION_COOLDOWN_MS = 750;
        ...
        switch (state) {
            ...
            case SHOOTING_FAR:
                ...
                if(ballsLoaded == 1) {
                    ...
                    if(shooter6 && currentTime - shootCallTime > 250 + 150 + 150 + 500 + 150 + 150) {
                        homeSpindexer();
                        shooter6 = false;
                        shootDone = true;
                    }
                    ...
                    if(shooter5 && currentTime - shootCallTime > 150 + 150 + 500 + 150 + 150) {
                        rotateSpindexer120(1);
                        shooter5 = false;
                        shooter6 = true;
                    }
                    ...
                    if(shooter8 && currentTime - shootCallTime > 150 + 150 + 500 + 150 + 150 + 500 + 150 + 150) {
                        homeSpindexer();
                        shootDone = true;
                        shooter8 = false;
                    }
