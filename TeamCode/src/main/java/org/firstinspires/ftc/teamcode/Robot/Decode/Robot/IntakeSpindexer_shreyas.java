...
public class IntakeSpindexer_shreyas {
    ...
    //  PURPLE thresholds
    // TODO; unblock this stuff
    /* private static final int PURPLE_RED_MIN = _;
    private static final int PURPLE_RED_MAX = _;
    private static final int PURPLE_GREEN_MIN = _;
    private static final int PURPLE_GREEN_MAX = _;
    private static final int PURPLE_BLUE_MIN = _;
    private static final int PURPLE_BLUE_MAX = _;

    //  GREEN thresholds
    private static final int GREEN_RED_MIN = _;
    private static final int GREEN_RED_MAX = _;
    private static final int GREEN_GREEN_MIN = _;
    private static final int GREEN_GREEN_MAX = _;
    private static final int GREEN_BLUE_MIN = _;
    private static final int GREEN_BLUE_MAX = _; */
